...
public class EISTOCK {
    ...
    public static void main(String[] args) {
        ...
        var nTransactions = sc.nextInt();
        var mapTransactions = new HashMap<Long, Transaction>();
        for (int i = 0; i < nTransactions; i++) {

            var sign = sc.next();
            var id = sc.nextLong();
            var quantity = sc.nextLong();
            var valueOfGoods = sc.nextLong();
            Transaction ts = null;
        ...
        var listTransactions = new ArrayList<Transaction>(mapTransactions.values());
